...
class RotationWithTSPlugin : Plugin,UserStudyRecordPluginProtocol {
    ...
    var pluginIdentifier: String = "Rotation with TS"
    ...
    func didUpdateFrame(scene: PenScene, buttons: [Button : Bool]){
        ...
        if checked == true && firstSelection == true && pressedBool == false {
            ...
            //studyData.updateValue(String(userStudyReps), forKey: "Number of Repetition:")
            ...
            studyData.updateValue(String(translationSum), forKey: "Amount of pan across touchscreen in attempt " + String(userStudyReps))
            //studyData.updateValue(String(rotationOnScreen), forKey: "Amount of rotation gesture on touchscreen in attempt " + String(userStudyReps))
            ...
            print("translationSum: ", translationSum)
        ...
        if userStudyReps == 6{
            ...
            recordManager.addNewRecord(withIdentifier: "Touchscreen Rotation", andData: studyData)
        }
