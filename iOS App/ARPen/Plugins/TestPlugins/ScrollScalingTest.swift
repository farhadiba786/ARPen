...
class ScrollScalingTestPlugin: Plugin, UserStudyRecordPluginProtocol {
    ...
    override init() {
        ...
        self.pluginImage = UIImage.init(named: "ScrollScalingPlugin")
        self.pluginInstructionsImage = UIImage.init(named: "ScrollScalingPlugin")
        self.pluginIdentifier = "Test:Scrolling"
