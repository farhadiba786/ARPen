...
class PinchScalingTestPlugin: Plugin, UserStudyRecordPluginProtocol {
  ...
  //Gesture Recognizer
    ...
    override init() {
        ...
        self.pluginImage = UIImage.init(named: "PinchScalingPlugin")
        self.pluginInstructionsImage = UIImage.init(named: "PinchScalingPlugin")
        self.pluginIdentifier = "Test:PinchScaling"
