...
class DirectPenScalingTestPlugin: Plugin, UserStudyRecordPluginProtocol {
    ...
    */
    override init() {
        ...
        self.pluginImage = UIImage.init(named: "DirectPenPlugin")
        self.pluginInstructionsImage = UIImage.init(named: "DirectPenPlugin")
        self.pluginIdentifier = "Test:DirectPen"
    ...
    override func didUpdateFrame(scene: PenScene, buttons: [Button : Bool]) {
        ...
        if pressed{
            ...
            if let corner = self.insideSphere{
                corner.geometry?.firstMaterial?.diffuse.contents = UIColor.yellow
