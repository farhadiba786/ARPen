...
class PointScalingTestPlugin: Plugin, UserStudyRecordPluginProtocol {
    ...
    override init() {
        ...
        self.pluginImage = UIImage.init(named: "PointScalingPlugin")
        self.pluginInstructionsImage = UIImage.init(named: "PointScalingPlugin")
        self.pluginIdentifier = "Test:PointScaling"
