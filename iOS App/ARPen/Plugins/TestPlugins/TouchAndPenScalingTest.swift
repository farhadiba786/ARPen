...
class TouchAndPenScalingTestPlugin: Plugin, UserStudyRecordPluginProtocol {
    ...
    override init() {
        ...
        self.pluginImage = UIImage.init(named: "TouchAndPenScalingPlugin")
        self.pluginInstructionsImage = UIImage.init(named: "TouchAndPenScalingPlugin")
        self.pluginIdentifier = "Test:Touch&Pen"
