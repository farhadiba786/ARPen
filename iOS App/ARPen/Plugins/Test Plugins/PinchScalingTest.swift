...
class PinchScalingTest: Plugin, UserStudyRecordPluginProtocol {
    ...
    var pluginIdentifier: String = "Test:PinchScaling"
    ...
    func activatePlugin(withScene scene: PenScene, andView view: ARSCNView) {
        ...
        /*let text = SCNText(string: "TEST", extrusionDepth: 0.2)
        ...
        node.geometry = text
        if node != scene.drawingNode.childNode(withName: "node", recursively: false){
            node.name = "node"
