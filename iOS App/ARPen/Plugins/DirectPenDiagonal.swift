...
class DirectPenPlugin: Plugin, UserStudyRecordPluginProtocol {
        ...
        if pressed{
            ...
            if let selectedCorner = self.insideSphere{
                ...
                if selected == true {
                    ...
                    var hitTestResult = sceneView.hitTest(projectedPenTip, options: [SCNHitTestOption.searchMode : SCNHitTestSearchMode.all.rawValue] )
