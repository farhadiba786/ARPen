...
class PinchScalingUserStudyPlugin: Plugin, UserStudyRecordPluginProtocol {
  ...
  //Gesture Recognizer
    ...
    //var delegate: PinchScalingPluginDelegate?
     ...
     @IBOutlet var confirmButton: UIButton!
       ...
       @IBOutlet var instructLabel: UILabel!
    ...
    override init() {
        ...
        self.pluginIdentifier = "PinchScaling"
        self.needsBluetoothARPen = false
        self.pluginDisabledImage = UIImage.init(named: "ARMenusPluginDisabled")
        nibNameOfCustomUIView = "PinchScalingPlugin"
    ...
    @IBAction func pressedUndoButton(_ sender: Any) {
